...
# saveRDS(wqp_pull_trib, "Documents/WQP/wqp_full_trib.rds")
# write_csv(wqp_pull_trib, "Documents/WQP/wqp_full_trib.csv")
# 
# wqp_pull_ls <- TADA_BigDataRetrieval(huc = "04020300", startDate = "2010-01-01", endDate = "2023-12-31")
# saveRDS(wqp_pull_ls, "Documents/WQP/wqp_full_ls.rds")
# write_csv(wqp_pull_ls, "Documents/WQP/wqp_full_ls.csv")

# wqp_trib <- readRDS("Documents/WQP/wqp_full_trib.rds") %>%
#   TADA_AutoClean() %>%
#   filter(TADA.LatitudeMeasure > 46) #drop sites missing lat/long
# 
# wqp_ls <- readRDS("Documents/WQP/wqp_full_ls.rds") %>%
#   TADA_AutoClean() %>%
...
# write_csv(synref, "Documents/WQP/synref.csv", na = "")
# read in once edits are done
# synref <- read_csv("Documents/WQP/Synonym Reference Table.csv") 
...
# 
# wqp <- select(wqp, -all_of(wqp_drop_cols(wqp))) #%>%
...
#write_rds(wqp, "Documents/WQP/wqp.rds")
